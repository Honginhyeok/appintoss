...
class ErrorBoundary extends react_1.default.Component {
    ...
    render() {
        ...
        if (this.state.hasError) {
            return (<div style={{ padding: '40px 24px', textAlign: 'center', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#fff' }}>
          ...
          <p style={{ fontSize: '14px', color: '#8b95a1', marginBottom: '24px', maxWidth: '320px', lineHeight: '1.5' }}>
            {((_a = this.state.error) === null || _a === void 0 ? void 0 : _a.message) || '알 수 없는 오류'}
          </p>
