...
const communityBoardRoutes_1 = __importDefault(require("./routes/communityBoardRoutes"));
const tossAuthRoutes_1 = __importDefault(require("./routes/tossAuthRoutes"));
const app = (0, express_1.default)();
app.use((0, helmet_1.default)({ contentSecurityPolicy: false })); // CSS/JS scripts are loaded from various sources so CSP is disabled for now
app.use((0, cors_1.default)({ origin: true, credentials: true }));
app.use(express_1.default.json());
app.use((0, cookie_parser_1.default)());
app.use(express_1.default.static(path_1.default.join(__dirname, '../public')));
// Set up routes
app.use('/api/auth/toss', tossAuthRoutes_1.default);
app.use('/api/toss', tossAuthRoutes_1.default); // 토스 공식 등록 redirect_uri (/api/toss/callback) 연동 매핑용 추가
...
app.use('/api/in-app-notifications', inAppNotificationRoutes_1.default);
app.use('/api/community-board', communityBoardRoutes_1.default);
exports.default = app;
